...
if (is_file($envFile)) {
    foreach (file($envFile, FILE_IGNORE_NEW_LINES | FILE_SKIP_EMPTY_LINES) as $line) {
        ...
        // Always override — .env file wins over server environment
        putenv("$key=$value");
        $_ENV[$key] = $value;
        $_SERVER[$key] = $value;
    }
...
return $GLOBALS['__TCM_CONFIG'] = [
    'app' => [
        ...
        'url'       => env('APP_URL', 'https://www.thecodemunk.in'),
    ...
    'db' => [
        ...
        'database' => env('DB_DATABASE', 'u743529483_tcm'),
    ...
    'mail' => [
        ...
        'from_email' => env('MAIL_FROM', env('MAIL_USERNAME', 'thecodemunk@gmail.com')),
