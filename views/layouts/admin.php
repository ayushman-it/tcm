...
$nav = [
    ...
    ['Growth',    [['/admin/leads',        'bi-megaphone',            'Leads'],
                   ['/admin/payments',     'bi-cash-coin',            'Payments'],
                   ['/admin/lead-forms',   'bi-link-45deg',           'Lead Forms'],
    ...
    ['System',    [['/admin/live-class',   'bi-broadcast',            'Live Class'],
                   ['/admin/wallet',       'bi-wallet2',              'Wallet & Payouts'],
...
$fl   = strtoupper(substr($admin['name'] ?? 'A', 0, 1)); // kept for legacy, not used in avatar render
...
<head>
    ...
    <meta name="apple-mobile-web-app-title" content="TCM Admin">
    ...
    <aside class="tcm-sidebar" id="sidebar">
        ...
        <div class="tcm-sidebar-footer">
            <div class="tcm-sidebar-user">
                <div class="tcm-avatar" style="width:30px;height:30px;font-size:.72rem;overflow:hidden;">
                    <?= tcm_avatar($admin['avatar'] ?? null, $name) ?>
                </div>
    ...
    <div class="tcm-main">
        ...
        <div class="tcm-topbar">
            ...
            <div class="tcm-topbar-right">
                ...
                <div class="tcm-avatar" style="font-size:.8rem;cursor:default;overflow:hidden;"
                     title="<?= e($name) ?>">
                    <?= tcm_avatar($admin['avatar'] ?? null, $name) ?>
                </div>
            </div>
...
document.addEventListener('DOMContentLoaded', function () {
    if (window.TCMNotifications) {
        TCMNotifications.init('admin', <?= (int)($admin['id'] ?? 0) ?>);
    }
});
</script>
</body>
